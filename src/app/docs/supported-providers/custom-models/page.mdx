...
For custom models, you must specify the model's capabilities using the `modelInfo` field. This helps kagent understand what features your model supports and how to interact with it effectively. For detailed information about model capabilities and how to configure them, see [Model Information](/docs/concepts/model-info).
