...
- **[What is kagent?](/docs/introduction/what-is-kagent)**: Learn about the core concepts and capabilities of kagent.
- **[Installation](/docs/introduction/installation)**: Follow our guide to set up kagent.
