...
1. Create a boilerplate for an `echo` MCP tool in the `src/tools` directory of your MCP project. You can use the boilerplate as a base to create your own tools.  
   ```sh
