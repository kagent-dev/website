...
Autogen requires certain information about any model to be able to use it. Autogen ships with a default set of models, but you can also add custom models.
