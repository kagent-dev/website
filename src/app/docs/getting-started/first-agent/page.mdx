...
Before you being make sure you have a Kubernetes cluster with kagent installed. If you haven't done this yet, check out the [installation guide](/docs/introduction/installation) or the [quickstart guide](/docs/getting-started/quickstart).
