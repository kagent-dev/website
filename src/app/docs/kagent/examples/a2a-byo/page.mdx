...
3. From the output of the previous step, get the image repo and tag, `localhost:5001/kagent-dev/kagent/kagent-adk:v0.5.5` and pull the image. 

   ```bash
   docker pull localhost:5001/kagent-dev/kagent/kagent-adk:v0.5.5
   ```

4. Tag and push the image as latest.

   ```bash
   docker tag localhost:5001/kagent-dev/kagent/kagent-adk:v0.5.5 localhost:5001/kagent-dev/kagent/kagent-adk:latest
