...
<table border="0" cellspacing="0" cellpadding="0" style={{ borderCollapse: "collapse" }}>
  <tr>
    <td width="55%" style={{ border: "none" }}><img src="telegram.gif" alt="Telegram Demo" width="100%" /></td>
    <td width="40%" style={{ border: "none" }}><img src="arch.png" alt="Architecture" width="100%" /></td>
  </tr>
</table>
