...
Make sure that your Amazon Web Services (AWS) account has:

1. Access to Amazon Bedrock
2. Permissions to create API keys with access to Bedrock models
3. Access to the specific Bedrock models you want to use
