...
<div className="max-w-3xl mx-auto">
    ...
    <QuickLink title="Azure AI Foundry" description="Learn how to configure Azure AI Foundry models and Azure Workload Identity for kagent." href="/docs/kagent/supported-providers/azure-ai-foundry" />
    ...
    <QuickLink title="SAP AI Core" description="Learn how to configure SAP AI Core models for kagent." href="/docs/kagent/supported-providers/sap-ai-core" />
