...
You can bring your own model from an [OpenAI API-compatible](https://platform.openai.com/docs/api-reference/introduction) LLM provider.

1. Save your API key from the OpenAI-compatible provider as an environment variable.
...
3. Create a ModelConfig resource.
   ...
   | `baseUrl` | The base URL of your LLM provider, such as `api.cohere.ai` for [Cohere AI](https://cohere.com/). |
