...
<div className="max-w-3xl mx-auto">
    ...
    <QuickLink title="Reliability" description="Configure tool call retries with reflection, model call limits, debug logging, and LLM request retries." href="/docs/kagent/concepts/reliability" />
    </div>
</div>
