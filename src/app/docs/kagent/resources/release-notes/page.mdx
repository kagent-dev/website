...
1. Check for an existing MCPServer CRD. If you have one, delete it.

   ```shell
   kubectl get crds | grep mcpserver
   ...
   ```
   NAME                           CREATED AT
   mcpservers.kagent.dev          2025-08-20T18:22:10Z
   ...
   customresourcedefinition.apiextensions.k8s.io "mcpservers.kagent.dev" deleted

   ```

2. Install the kagent CRD Helm chart.
