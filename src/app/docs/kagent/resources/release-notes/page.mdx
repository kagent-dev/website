...
- Customize the bundled instance via `database.postgres.bundled.*` (storage size, image, credentials) as needed. See the [installation guide](/docs/kagent/introduction/installation#database-configuration) for details.
