...
```bash
curl -LO https://github.com/kagent-dev/kagent/releases/download/v0.0.3/kagent-darwin-arm64
...
Commands:
  ...
  help           display help
  install        Install kagent to the current cluster.
  uninstall      Uninstall kagent from the current cluster.
