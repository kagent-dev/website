...
Before you being make sure you have a Kubernetes cluster with kagent installed. If you haven't done this yet, check out the [installation guide](/docs/installation) or the [quickstart guide](/docs/quickstart).
