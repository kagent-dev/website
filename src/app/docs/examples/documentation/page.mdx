...
We're going to use the [doc2vec](https://github.com/kagent-dev/doc2vec) project to crawl the [MCP documentation](https://modelcontextprotocol.io/) websize and store the content in a [sqlite-vec](https://github.com/asg017/sqlite-vec) database.
