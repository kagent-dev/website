...
![Slack - A2A - MCP - kagent](/images/discord-bot/slack-a2a-kagent.png)
...
![Create an app](/images/discord-bot/1-create-slack-app.png)

2. Choose "From scratch" options and give your app a name (we'll use `My kagent app`) and pick a workspace.

![Configure your app](/images/discord-bot/2-name-workspace.png)
...
![Bot Token Scopes](/images/discord-bot/bot-token-scopes.png)
...
![Install to workspace](/images/discord-bot/install-app.png)

If you open your Slack workspaces you'll notice the "My kagent app" is added to the list of apps.

![Kagent app installed in Slack](/images/discord-bot/app-in-slack.png)
...
![Generate app-level token](/images/discord-bot/app-level-token.png)
...
3. Fill out the form with the following values:
    ![Create slash command](/images/discord-bot/slash-commands.png)
4. Click Save.
...
![Agent response in Slack](/images/discord-bot/show-pods.png)
...
![Sending message to Slack](/images/discord-bot/send-to-slack.png)

You should see the message in the Slack channel:

![Message in Slack](/images/discord-bot/message-in-slack.png)
