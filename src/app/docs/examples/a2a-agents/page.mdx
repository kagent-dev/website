...
title: "A2A Agents"
pageOrder: 1
description: "Learn how to expose agents through the A2A protocol."
---
...
We'll use the A2A host CLI to call the agent. This CLI part of the [A2A repository](https://github.com/google/A2A/tree/main/samples/python/hosts/cli). Start by cloning the repository:
