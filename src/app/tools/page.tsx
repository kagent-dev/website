      ...
      <div className="min-h-screen">
        <div className="border-b border-white/10">
          <div className="max-w-6xl mx-auto px-6 py-8">
            <h1 className="text-3xl font-medium mb-4 font-heading">Tools Registry</h1>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="mt-20 py-12 px-8 border border-white/10 rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 text-center">
            <h2 className="text-2xl font-medium mb-3 font-heading">Can&apos;t find what you&apos;re looking for?</h2>
