---
title: kagent
linkTitle: "kagent 1.x"
description: Explore concepts, guides, and reference docs for running declarative AI agents on Kubernetes with Agent Substrate, from install through day-two operations.
weight: 10
author: kagent.dev
---
