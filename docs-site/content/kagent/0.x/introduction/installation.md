...
This guide covers ways to install and configure kagent in your Kubernetes environment. For a quick setup, see the [Quick Start Guide]({{< link path="getting-started/quickstart" >}}). For enterprise offerings, see [Solo Enterprise for kagent]({{< link path="introduction/what-is-kagent/#enterprise-distributions" >}}).
