...
**Subcommands:**
- [`kagent completion bash`]({{< link path="resources/cli/kagent-completion-bash/" >}}) - Generate the autocompletion script for bash
- [`kagent completion fish`]({{< link path="resources/cli/kagent-completion-fish/" >}}) - Generate the autocompletion script for fish
- [`kagent completion powershell`]({{< link path="resources/cli/kagent-completion-powershell/" >}}) - Generate the autocompletion script for powershell
- [`kagent completion zsh`]({{< link path="resources/cli/kagent-completion-zsh/" >}}) - Generate the autocompletion script for zsh
