...
**Subcommands:**
- [`kagent mcp add-tool`]({{< link path="resources/cli/kagent-mcp-add-tool/" >}}) - Add a new MCP tool to your project
- [`kagent mcp build`]({{< link path="resources/cli/kagent-mcp-build/" >}}) - Build MCP server as a Docker image
- [`kagent mcp deploy`]({{< link path="resources/cli/kagent-mcp-deploy/" >}}) - Deploy MCP server to Kubernetes
- [`kagent mcp init`]({{< link path="resources/cli/kagent-mcp-init/" >}}) - Initialize a new MCP server project
- [`kagent mcp run`]({{< link path="resources/cli/kagent-mcp-run/" >}}) - Run MCP server locally
- [`kagent mcp secrets`]({{< link path="resources/cli/kagent-mcp-secrets/" >}}) - Manage project secrets
